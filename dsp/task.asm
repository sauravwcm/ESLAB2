...
;* Date/Time created: Sat May 30 16:39:43 2015                                *
;******************************************************************************
...
;	/data/usr/local/share/c6000/bin/opt6x /tmp/036147nSeEH /tmp/03614nlhaCM 
	.sect	".text"
	.clink
	.global	_sum_dsp
...
$C$DW$45	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$45, DW_AT_name("/home/ubuntu/esLAB/mod_pool_notify/dsp/task.asm:$C$L3:1:1432996783")
...
$C$DW$46	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$46, DW_AT_low_pc($C$DW$L$_sum_dsp$8$B)
	.dwattr $C$DW$46, DW_AT_high_pc($C$DW$L$_sum_dsp$8$E)
	.dwendtag $C$DW$45


$C$DW$47	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$47, DW_AT_name("/home/ubuntu/esLAB/mod_pool_notify/dsp/task.asm:$C$L1:1:1432996783")
...
$C$DW$49	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$49, DW_AT_low_pc($C$DW$L$_sum_dsp$5$B)
	.dwattr $C$DW$49, DW_AT_high_pc($C$DW$L$_sum_dsp$5$E)
	.dwendtag $C$DW$47
...
$C$DW$50	.dwtag  DW_TAG_subprogram, DW_AT_name("Task_notify")
	...
	.dwattr $C$DW$50, DW_AT_TI_begin_line(0x9b)
...
;** 158	-----------------------    mpcsInfo = (struct _Task_TransferInfo_tag *)arg;
;** 162	-----------------------    v$1 = count+1;
;** 162	-----------------------    count = v$1;
;** 163	-----------------------    if ( v$1 != 1 ) goto g3;
;** 164	-----------------------    buf = (unsigned char * const)info;
;**	-----------------------g3:
;** 166	-----------------------    if ( v$1 != 2 ) goto g5;
;** 167	-----------------------    length = (int)info;
;**	-----------------------g5:
;** 170	-----------------------    SEM_post((struct _SEM_Obj *)mpcsInfo+4);
;**  	-----------------------    return;
           MVKL    .S1     _count$1,A4
           MVKH    .S1     _count$1,A4
           LDW     .D1T1   *A4,A3            ; |162| 
...
$C$DW$55	.dwtag  DW_TAG_subprogram, DW_AT_name("Task_execute")
	...
	.dwattr $C$DW$55, DW_AT_frame_base[DW_OP_breg31 16]
...
;** 116	-----------------------    SEM_pend((struct _SEM_Obj *)info+4, 0xffffffffu);
;** 119	-----------------------    BCACHE_inv(*&buf, (unsigned)length, 1u);
;** 103	-----------------------    sum = 0;  // [11]
;** 104	-----------------------    if ( (C$2 = length) <= 0 ) goto g4;  // [11]
...
;**	-----------------------g4:
;** 125	-----------------------    NOTIFY_notify(1u, 0u, 5u, 0u);
;** 127	-----------------------    NOTIFY_notify(1u, 0u, 5u, (unsigned)sum);
;** 129	-----------------------    return 0;
...
$C$DW$62	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$62, DW_AT_name("/home/ubuntu/esLAB/mod_pool_notify/dsp/task.asm:$C$L9:1:1432996783")
	.dwattr $C$DW$62, DW_AT_TI_begin_file("task.c")
	.dwattr $C$DW$62, DW_AT_TI_begin_line(0x68)
	.dwattr $C$DW$62, DW_AT_TI_end_line(0x6b)
$C$DW$63	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$63, DW_AT_low_pc($C$DW$L$_Task_execute$10$B)
	.dwattr $C$DW$63, DW_AT_high_pc($C$DW$L$_Task_execute$10$E)
	.dwendtag $C$DW$62


$C$DW$64	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$64, DW_AT_name("/home/ubuntu/esLAB/mod_pool_notify/dsp/task.asm:$C$L7:1:1432996783")
	.dwattr $C$DW$64, DW_AT_TI_begin_file("task.c")
	.dwattr $C$DW$64, DW_AT_TI_begin_line(0x68)
	.dwattr $C$DW$64, DW_AT_TI_end_line(0x6b)
$C$DW$65	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$65, DW_AT_low_pc($C$DW$L$_Task_execute$6$B)
	.dwattr $C$DW$65, DW_AT_high_pc($C$DW$L$_Task_execute$6$E)
$C$DW$66	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$66, DW_AT_low_pc($C$DW$L$_Task_execute$7$B)
	.dwattr $C$DW$66, DW_AT_high_pc($C$DW$L$_Task_execute$7$E)
	.dwendtag $C$DW$64
...
$C$DW$67	.dwtag  DW_TAG_subprogram, DW_AT_name("Task_delete")
	...
	.dwattr $C$DW$67, DW_AT_TI_begin_line(0x84)
...
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 9
;** 139	-----------------------    status = NOTIFY_unregister(1u, 0u, 5u, &Task_notify, (void * const)info);
;** 146	-----------------------    MEM_free(DDR2, (void * const)info, 40u);
;** 151	-----------------------    return status;
...
||         LDDW    .D2T1   *++SP,A11:A10     ; |152| 
	...
	.dwattr $C$DW$67, DW_AT_TI_end_line(0x98)
...
$C$DW$72	.dwtag  DW_TAG_subprogram, DW_AT_name("Task_create")
	...
	.dwattr $C$DW$72, DW_AT_TI_begin_line(0x19)
...
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 9
;** 34	-----------------------    *infoPtr = C$32 = (struct _Task_TransferInfo_tag *)MEM_valloc(DDR2, 40u, 0u, 0);
;** 37	-----------------------    U$4 = C$32;
;** 37	-----------------------    if ( U$4 ) goto g3;
;** 28	-----------------------    info = NULL;
;** 39	-----------------------    status = 1;
...
;** 27	-----------------------    status = 0;
;**	-----------------------g4:
;** 48	-----------------------    v$1 = (int)MPCSXFER_BufferSize;
;** 48	-----------------------    if ( status ) goto g6;
...
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 5
;** 50	-----------------------    (*info).dataBuf = NULL;
;** 51	-----------------------    (*info).bufferSize = v$1;
...
;** 61	-----------------------    if ( status = NOTIFY_register(1u, 0u, 5u, &Task_notify, (void *)info) ) goto g8;
           STW     .D1T2   B8,*A10           ; |50| 
...
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 5
;** 78	-----------------------    if ( !(status = NOTIFY_notify(1u, 0u, 5u, 0u)) ) goto g9;
...
;          EXCLUSIVE CPU CYCLES: 2
;**	-----------------------g9:
;** 92	-----------------------    C$29 = (struct _SEM_Obj *)info+4;
;** 92	-----------------------    SEM_pend(C$29, 0xffffffffu);
;** 93	-----------------------    SEM_pend(C$29, 0xffffffffu);
;** 95	-----------------------    return status;
           ADD     .L1     4,A10,A4          ; |92| 
...
||         LDW     .D2T1   *++SP(8),A11      ; |96| 
	...
	.dwattr $C$DW$72, DW_AT_TI_end_line(0x60)
